...
class TimelineTests(unittest.TestCase):
    ...
    def test_mixed_language_and_nested_direction_quotes(self):
        ...
        self.assertEqual(len(result['dialogue']), 1)
        self.assertAlmostEqual(result['dialogue'][0]['estimate'], 2/4+2/4)   # 1.7.0 default 4 words/s
    ...
    def test_english_speech(self):
        ...
        self.assertAlmostEqual(result['dialogue'][0]['estimate'], 2/4)   # 1.7.0 default 4 words/s
