<!-- 1.6.0 样本：theorder-ep03-s04-plan.md（项目 2026-09-23 快照）+ 维护者回填的"交付变化"列（非盲，按各 clip 分拍与 film-creative 3.7.0 事件轨 theorder-ep03-s04-v4.1-events.md 的锚句归属对齐）；其余逐字未改。clip03 连同余韵第 10 行；clip04 只有余韵第 11 行——用户看成片问"这 16 s 存在的意义是？"。 -->
...
| clip | 场内秒 | 时长 | 交付变化 | 分拍 | 主体 | 峰值事件 | 图 |
|---|---|---|---|---|---|---|---|
| s04-clip01 〈Up front〉 | 0–22 | 22 s | 第 1–2 行 | 晨跑、"Two more. Nobody walks. Marsh— up front."→Isa 加速越过 Cole→"You don't usually want me up front, Beck." / scouting sheet→"Has Cole seen that sheet?" / "Cole didn't want to read it." / 笑 / "So Game One's mine." | Beckett、Isa、Cole、队友 | Isa 加速越过 Cole 冲到队伍最前面（镜 2，低机位反向跟移随他加速） | 4 |
| s04-clip02 〈It's on me〉 | 22–50 | 28 s | 第 3–6 行 | "Game One could be yours…"→Isa 说出怕（"One bounce, he's on third…" / "…the scholarship kid…"）→"let Diego block it" / "And if he doesn't block it?" / "Then it's on me…"→Isa 看着他不答 | Beckett、Isa | Isa 说出奖学金生的怕（镜 2，正面反向跟移中缓推到 Isa 近景） | 3 |
| s04-clip03 〈To the line〉 | 50–72 | 22 s | 第 7–10 行 | "Last one. To the line." / "You're on."→冲刺、Isa 领先一个身位过线→Tess 秒表与板 CUT DAY — MONDAY→撑膝笑、Cole 一眼跑过→队伍跑进太阳 | Isa、Beckett、Tess、Cole、队友 | Isa 一点点压过 Beckett、领先一个身位过线（镜 2，侧跟拍加速） | 5 |
| s04-clip04 〈Bullpen〉 | 72–88 | 16 s | 第 11 行 | 几分钟后牛棚边：Isa 拉肩、Diego 绑护腿→Diego 蹲下拍手套看他→Isa 看着、Beckett 按肩走开→隔着围栏两人都没动 | Isa、Diego、Beckett、队友 | Diego 蹲到本垒板后拍手套、抬头看 Isa（镜 2，隔着围栏微推） | 7 |
