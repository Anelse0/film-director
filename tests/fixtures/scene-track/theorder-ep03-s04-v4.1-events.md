<!-- 3.7.0 校准样本（反例）：THE ORDER EP03 场 4 v4.1 采用稿快照（2026-09-23 14:21）正文逐字未改 + 事件轨（维护者回填，非盲）。牛棚段按 v4.1 自己的赌注卡如实回填：Isa 场末仍是"推迟"，卡上只在后面接了"Diego 在牛棚里蹲着等他，他还坐着"这个画面，没有人得到或失去什么 → 余韵。用户看成片问"这 16 s 存在的意义是？"。分镜实排 88 s。 -->
...
| 11 | Diego → Isa | 无（余韵：Isa 没答应，Diego 在等他） | — | Diego 已经蹲好等他（EP05 S03 他走进去的铺垫） | 牛棚（围栏内外） | 拉伸、等待 | 跳：几分钟后 | 几分钟后，牛棚边。 | 15 |
