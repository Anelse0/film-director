...
| 希区柯克变焦（dolly zoom） | 现实扭曲、眩晕、认知崩塌的一瞬 | 一部片用一次以上 | "希区柯克变焦：机器后拉同时变焦推近，人物大小不变、背景变大压向人物"（反过来前推同时变焦拉远，背景变小退远）。1.9.0 更正：原写"背景被拉远"方向反了——维基百科 Dolly zoom 条目示意图注："the teapots in the background grow bigger … camera moving back while zooming in" `[第三方]` |
...
动机、职能与"什么时候不用"按本节 2.1–2.2 定下之后，具体怎么写可以从运镜库（`assets/camera-library.json`，46 条）取一条，按它的五段——Camera / Movement / Speed / Framing / End——填成这一镜的内容：主体是谁、机位在哪一侧、多快、运动中什么保持不变、止于什么构图。库补的是"运动中什么不变"（Framing），不补动机；照抄通用句是 W34。用法、索引与检查见 `camera-library.md`。

### 2.5 摄影机身份、支撑与运动质感（1.9.0）

来源：用户提供资料《摄影机运动与支撑语言》（2026-09-23，未注出处）。定义类内容（摇 / 俯仰 / 升降台的区别，变焦不改变透视而移动机位会改变）与行业常识一致；"情绪倾向""很适合"一类说法是行业经验，标 `[第三方·未注出处]`，不作规则。"Seedance 风险"一栏只取能力表与本项目实测。

**四件事分开定**（动机，即"为什么现在必须动"，仍在 A 层，见 2.1）：

| 层 | 回答 | 写在哪 |
|---|---|---|
| 摄影机身份 | 观众站在哪里、和人物什么关系、会不会感到摄影机在场 | 场级视觉方案（S5 §5.1b），默认整场一个；单镜换身份在该镜 A 层写理由 |
| 支撑 | 用什么托住机器——决定运动的重量、惯性、稳定度 | 分镜卡运镜行（可选） |
| 运动 | 机器往哪里动：推 / 拉 / 摇 / 移 / 跟 / 升降 / 弧移 / 变焦……（2.2；运镜库五段 2.4） | 分镜卡运镜行 |
| 质感 | 这次运动给人的感觉 | 分镜卡运镜行（可选）；Prompt 里写成看得见的结果 |

顺序：先定身份；动机成立时再选运动；最后选支撑与质感。不按场景类型选（"派对就用斯坦尼康"不成立），按"这一刻观众应该处在什么心理位置"选。人物变了 → 观众和人物的关系要变 → 摄影机才变；写不出这条链就不换身份、不加运动。

同一表演、同一景别，运动不同意义就不同 `[第三方·未注出处]`：特写 + 固定 = 观察他承受；特写 + 手持 = 和他一起承受；中景 + 缓推 = 逐渐意识到这一刻重要；中景 + 拉远 = 看着他被世界抛下。

**摄影机身份**（"常见搭配"只是候选，不是映射；身份和"视点"是两件事——视点是观众跟谁、知道什么，身份是摄影机和人物的关系：同样跟着 Isa 的视点，可以旁观，也可以亲密观察）：

| 身份 | 观众的位置 | 常见搭配 |
|---|---|---|
| 旁观 | 冷静、不参与；人物在画内变化，世界不跟着他变 | 固定 |
| 亲密观察 | 靠近人物，几乎感觉不到摄影机 | 克制手持 |
| 参与 | 身在事件现场 | 手持 / 肩扛 |
| 陪伴 | 与人物同行 | 跟拍 / 侧跟 |
| 引导 | 在人物前面带着他走 | 反向跟拍 / 斯坦尼康 |
| 追随 | 从背后跟进人物的世界 | 身后跟拍 |
| 全知 | 超越人物视点 | 摇臂 / 航拍 |
| 角色主观 | 摄影机就是人物的眼睛 | 第一人称 |
| 显性摄影机 | 观众明显感到"摄影机在做动作" | 变焦 / 急推变焦 / 大角度环绕 |

**支撑**：对模型来说器材名只是在代指一种运动质感。能力表 §4.5 的官方术语与范例里有"手持（晃动）""斯坦尼康""航拍""升 / 降"；其余不单写器材名，写看得见的结果。风险编号见下表。

| 支撑 | 运动质感 | 资料说适合 `[第三方·未注出处]` | Seedance 风险 | Prompt 里怎么写 |
|---|---|---|---|---|
| 固定（三脚架） | 零运动；构图存在感高 | 对话、尴尬、压抑、权力关系 | ④（长时间固定靠画内纵深走位撑时） | "固定机位，全程不动" |
| 手持 | 呼吸、微漂移、可主动响应人物 | 冲突、突然事件、亲密 | ②③⑤ | "手持，轻微 / 明显 / 富攻击性的晃动"（官方范例用法） |
| 克制手持 | 画面有生命但不晃 | 关系戏、暧昧、私人谈话 | ③⑤ | "轻微手持，只有呼吸般的起伏和小幅重新构图，画面稳定" |
| 肩扛 | 有重量和惯性，比手持稳 | 体育、后台、更衣室、奔跑 | ②⑤ | 非官方术语："肩扛，随人走路的节奏上下起伏，但不抖" |
| 斯坦尼康 | 流畅，仍保留人走路的重量 | 走廊、进入新空间、长镜头 | ①④ | "斯坦尼康平稳跟随……"（官方范例用过） |
| 稳定器 | 极顺滑、漂浮；叙事里容易有广告感 | 广告、MV、快速穿越 | ②⑤ | 非官方术语："平滑漂浮地跟随，没有上下起伏" |
| 轨道 / 移动车 | 稳、有惯性；机位真正穿越空间，透视随之改变（变焦不会） | 关系、情绪变化、重要对白、揭示 | 低 | "镜头沿直线缓推 / 缓拉 / 横移，止于……" |
| 摇臂 / 小摇臂 | 大范围升降；仪式感 | 开场、结尾、典礼 | ①⑥ | "镜头升起到俯视全景，止于……"（升 / 降为官方术语） |
| 航拍 | 全知、宏大 | 地理建立、校园、球场 | ①⑥ | "航拍视角……"（官方热门术语） |
| 车载 | 人与载具关系稳定，背景高速流动 | 驾驶、追逐 | ② | 非官方术语："摄影机固定在车门外，与驾驶者同速……" |
| 身体固定（Snorricam） | 人物在画面里不动、世界在晃 | 醉酒、恐慌 | ②⑤ | 非官方术语："摄影机固定在他胸前、对着他的脸；他走动时脸在画面里不动，背景晃动" |

**运动质感**（资料的 10 个标签压成 6 个：反应式并入有机或紧张，观察式并入克制，正式并入精确）：

| 质感 | 写进 Prompt |
|---|---|
| 几乎无感 | 运动极慢、幅度极小，几乎觉察不到在动 |
| 克制 | 小幅、慢，只在需要时移动 |
| 精确 | 匀速、直线、平稳，起止明确 |
| 漂浮 | 平滑，没有上下起伏 |
| 有机 | 带人走路或呼吸的起伏，会小幅重新构图，随人物动作起停 |
| 紧张 / 攻击性 | 快、突然、贴近，追着人物动作 |

**资料说适合、但 Seedance 上有风险**（"风险"是要换载体、写具体或登记，不是禁用）：

| # | 情形 | 资料里说适合的例子 | 依据 | 处理 |
|---|---|---|---|---|
| ① | 人群、多主体 | 斯坦尼康穿过派对人群、摇臂升到典礼或球场全景、群戏摇镜、航拍球场 | `[官方]` 2.5 博客把多主体互动稳定性列为待改进（能力表 §4.6、§4.8）；`[实测·单样本]` THE ORDER EP03 场 4 clip01 设计十几人晨跑，出片只有四人（`validation-log.md` 2026-09-23） | 人数写数字；人群里的关键人物给识别点；人群规模要紧时用关键帧或场景图 |
| ② | 快速运动 | 追逐、奔跑、体育、甩镜、稳定器快速穿越、车载 | `[官方]` 2.0 指南"规避狂奔、大跳、剧烈翻滚"，2.5 博客弱项"复杂运动的物理合理性"（§4.6）；`[第三方]` 快速动作仍有形变（能力表 §5） | 快动作和快运镜不叠在同一镜；登记风险；关键动作用动作参考视频（§七） |
| ③ | 说台词时的运动 | 手持或克制手持拍对白、侧跟边走边说、弧移对峙、环绕两人 | `[第三方]` 正面或 3/4 侧脸中近景锁机位口型最稳，侧脸不可靠（能力表 §5）；`[官方]` 多人口型同步是未解决问题（§4.8）；`[实测·单样本]` THE ORDER EP03 场 4：正面反向跟移双人对白、近景推近说长句执行到位，侧跟双人只验证过两句短句 | 长台词优先正面或 3/4 侧的固定、推、正面反向跟移；侧跟、弧移、环绕放在无台词段或只配短句；弧移和环绕不用于两人对白（2.2 环绕行） |
| ④ | 长时间、复合、纵深运动 | 斯坦尼康"从身后跟着穿过人群、再绕到正面"，180° / 360° 环绕，靠纵深走位撑的固定长镜头 | `[官方]` 时间段内内容太少模型会自由发挥（`duration-rhythm.md` §一），2.0 指南一镜一种运镜（能力表 §4.5）；本 skill：文字驱动 15 s 以上纵深走位或环绕为高风险（硬规则 16、§七） | 拆成先后两段并写清顺序；超过四分之一圈或 15 s 的交给关键帧或白模 |
| ⑤ | 质感能否被分辨 | 克制手持 vs 固定，斯坦尼康 vs 稳定器 vs 肩扛，变焦 vs 推 | `[未验证]`：官方术语只到"手持晃动""斯坦尼康"；本项目抽帧审片只能确认构图，看不出运动质感（EP03 场 4 clip01 镜 4"手持斜前"只确认了构图） | 质感写成看得见的结果（幅度、快慢、有无起伏）；要判断执行了没有，看成片，不看抽帧——`measure_clip.py` 的镜内运动（首末帧差）只能分出动与不动 |
| ⑥ | 揭示新空间 | 拉远、航拍、升、摇揭示、弧移换背景 | `[第三方]` "地点写得模糊是多镜头序列切换后漂移的最常见原因"（能力表 §5）；`[实测·单样本]` EP03 场 4 clip01 背景是海、clip03 是外野后的石头大楼 | 被揭示的空间写具体（陈设、地标、方位），或给场景图 |
| ⑦ | 主观镜头露出手 | 第一人称寻找、偷窥、奔跑 | 本 skill 风险登记：手部精细动作（S7 §7.1） | 手只做简单动作；需要精细手部时改用客观镜头 |
...
| 角色外观、场景光与陈设 | 弱（跨 clip 漂移） | 主体图 + 场景空镜；衣着 → 服装图或逐镜文字（形象图的衣服会被带进成片，stage-5b §5b.3a） | S5b |
