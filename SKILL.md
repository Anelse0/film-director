...
- **场景稿是交接物与台词锁**（film-creative 的 `03_script/scene-XX.md`：逐字台词、动作行、头部注明锁定句与来源）：S4/S6 从场景稿的台词与动作行映射每句〔说法〕、每镜〔情绪〕与【整体情绪弧线】，场景稿里没有的句子不进 Prompt；有台词设计表（按需的逐句诊断物，每句：目的动词 · 潜台词 · 说法 · 听者反应）时直接取用，不重新推导。无场景稿时按剧本层缺口登记、交回 film-creative，不由生产侧补写台词；只有用户明确说"台词就这样"锁定糙台词时，才在对话里补出〔说法〕并标"生产侧补写、待创作侧确认"，落盘文件头部写明台词来源。两个 skill 之间谁交给谁什么、正典改了怎么同步、台词超长怎么回传，统一见 `references/handoff-contract.md`。
