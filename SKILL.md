...
- **台词设计表**（film-creative 的交接物，每句：目的动词 · 潜台词 · 说法 · 听者反应 · 情绪递进 · 收尾标记）：有表时 S4/S6 直接映射为每句〔说法〕、每镜〔情绪〕与【整体情绪弧线】，不重新推导；无表时按剧本层缺口登记、交回 film-creative 出表（生产版：每句一行、逐字、来源标注），不由生产侧补写台词；只有用户明确说"台词就这样"锁定糙台词时，才在对话里补出〔说法〕并标"生产侧补写、待创作侧确认"，落盘文件头部写明台词来源。两个 skill 之间谁交给谁什么、正典改了怎么同步、台词超长怎么回传，统一见 `references/handoff-contract.md`。
